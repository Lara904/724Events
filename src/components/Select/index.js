...
const Select = ({
  ...
  const changeValue = (newValue) => {
    ...
    setCollapsed(false); // Met à jour "collapsed" en fonction de la nouvelle valeur (il semblerait qu'il y ait une correction manquante ici, peut-être "setCollapsed(!newValue)" serait approprié).
  };
  return (
